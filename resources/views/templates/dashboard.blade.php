          ...
          <ul class="nav-menus">
            ...
            <li class="profile-nav onhover-dropdown p-0 me-0">
              ...
              <ul class="profile-dropdown onhover-show-div">
                ...
                <li><a href="{{ url('/my-profile/edit-password') }}"><i data-feather="file-text"></i><span>Change
                      Password</span></a></li>
                <li><a href="javascript:void(0)" onclick="confirmLogout()"><i data-feather="log-out"> </i><span>Log
                      Out</span></a></li>
              </ul>
            </li>
          </ul>
      ...
      <div class="sidebar-wrapper">
        <div>
          <div class="logo-wrapper" style="display: flex; align-items: center; padding: 15px 10px;">
            <a href="{{ url('/dashboard') }}" style="flex-shrink: 0;"><img class="img-fluid for-light"
                src="{{ asset('/storage/' . $settings->logo) }}" style="width: 40px; height: 40px; border-radius: 50%;"
                alt=""></a>
            <span
              style="font-size: 13px; color: white; font-weight: 600; margin-left: 8px; flex: 1; max-width: 140px; line-height: 1.2;">{{ $settings->name }}</span>
            <div class="toggle-sidebar" style="flex-shrink: 0; margin-left: auto;"><i
                class="fa fa-cog status_toggle middle sidebar-toggle"> </i></div>
          </div>
              ...
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="menu-box">
                  <ul>
                    ...
                    <li class="sidebar-list">
                      <a class="sidebar-link sidebar-title link-nav" href="{{ url('/notifications') }}"><i
                          data-feather="bell"></i>
                    ...
                    <li class="sidebar-list">
                      <a class="sidebar-link sidebar-title link-nav" href="{{ url('/my-profile') }}"><i
                    ...
                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('hrd') || auth()->user()->hasRole('general_manager'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/pegawai') }}"><i
                    ...
                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('hrd') || auth()->user()->hasRole('general_manager'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/kontrak') }}"><i
                            data-feather="trending-up"> </i><span>Kontrak</span></a>
                      </li>
                      ...
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/jabatan') }}"><i
                            data-feather="package"> </i><span>Divisi</span></a>
                      </li>
                    @endif

                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('kepala_cabang') || auth()->user()->hasRole('hrd') || auth()->user()->hasRole('general_manager'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/lokasi-kantor') }}"><i
                            data-feather="map-pin"> </i><span>Lokasi</span></a>
                      </li>
                    @endif

                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('general_manager') || auth()->user()->hasRole('finance'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/rekap-data') }}"><i
                            data-feather="credit-card"> </i><span>Rekap Data</span></a>
                      </li>
                    @endif

                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('general_manager') || auth()->user()->hasRole('hrd'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/data-cuti') }}"><i
                            data-feather="shuffle"> </i><span>Cuti</span></a>
                      </li>
                    @endif
                    ...
                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('hrd') || auth()->user()->hasRole('general_manager'))
                      ...
                      <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                            data-feather="map"></i><span>Patroli</span></a>
                        <ul class="sidebar-submenu">
                      ...
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/kunjungan') }}"><i
                            data-feather="navigation"> </i><span>Kunjungan</span></a>
                      </li>

                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/penugasan') }}"><i
                            data-feather="award"> </i><span>Penugasan</span></a>
                      </li>

                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="{{ url('/rapat') }}"><i
                            data-feather="monitor"> </i><span>Rapat</span></a>
                      </li>

                      <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                            data-feather="wind"></i><span>Kinerja Pegawai</span></a>
                        <ul class="sidebar-submenu">
                      ...
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Request::is('laporan-kerja*') ? 'active' : '' }}"
                          href="{{ url('/laporan-kerja') }}"><i data-feather="message-square"> </i><span>Laporan
                            Kerja</span></a>
                      </li>
                    @endif
                    ...
                    @if (auth()->user()->hasRole('admin'))
                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Request::is('berita*') ? 'active' : '' }}"
                          href="{{ url('/berita') }}"><i data-feather="star"> </i><span>Berita & Informasi</span></a>
                      </li>

                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Request::is('settings*') ? 'active' : '' }}"
                          href="{{ url('/settings') }}"><i data-feather="settings"> </i><span>Settings</span></a>
                      </li>

                      <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Request::is('backup*') ? 'active' : '' }}"
                          href="{{ url('/backup') }}"><i data-feather="database"> </i><span>Backup & Restore</span></a>
                      </li>
                    @endif
