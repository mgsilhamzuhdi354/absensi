        ...
        <div class="tf-container">
            <div class="tf-balance-box">
                ...
                <div class="d-flex justify-content-between align-items-start gap-3">
                    <div>
                        <h3 class="mb-1">{{ $inventory->nama_barang ?? 'BAST Pengembalian Aset' }}</h3>
    ...
    <div id="app-wrap">
        <div class="bill-content">
            <div class="tf-container">
                ...
                <div class="p-3 mt-3 bast-panel">
                    ...
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <th>Pengembali</th>
                                <td>{{ $document->nama_pengembali ?? '-' }}</td>
                            </tr>
                            <tr>
                                <th>Penerima IT</th>
                                <td>{{ $document->nama_penerima ?? '-' }}</td>
                            </tr>
                            <tr>
                                <th>Mengetahui</th>
                                <td>{{ $document->nama_mengetahui ?? '-' }}</td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td>
                ...
                <div class="p-3 mt-3 bast-panel">
                    <h4 class="mb-3">Aset Yang Dikembalikan</h4>
                    <table class="table table-sm">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <th>Warna</th>
                                <td>{{ optional($document->returnTransaction)->warna_barang ?? optional($document->originalTransaction)->warna_barang ?? 'Umum' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Catatan</th>
                                <td>{!! $document->catatan ? nl2br(e($document->catatan)) : '-' !!}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="p-3 mt-3 bast-panel">
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{ url('/my-inventory-return-bast/'.$document->id.'/download') }}" class="btn btn-primary">
                            Download BAST
                        </a>
                        <a href="{{ url('/my-inventory-return-bast') }}" class="btn btn-light">
                            Kembali
                        </a>
                    </div>
                        ...
                        @foreach ($signatureRoles as $role => $config)
                            ...
                            <div class="col-md-4">
                                <div class="signature-card">
                                    ...
                                    @if ($canSign && !$isSigned)
                                        <form method="post" action="{{ url('/my-inventory-return-bast/'.$document->id.'/sign/'.$role) }}" class="mt-3" data-signature-form>
                                            @csrf
                                            ...
                                            <div class="form-check mt-2">
                                                <input type="checkbox" class="form-check-input" id="return_agreement_{{ $role }}" name="agreement" value="1" required>
                                                <label class="form-check-label small" for="return_agreement_{{ $role }}">
