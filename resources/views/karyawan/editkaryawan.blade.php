                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('no_pkwt') is-invalid @enderror"
                                            id="no_pkwt" name="no_pkwt" value="{{ old('no_pkwt', $karyawan->no_pkwt) }}">
                                        @error('no_pkwt')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <select name="hubungan_kontak_darurat" id="hubungan_kontak_darurat"
                                            ...
                                            @foreach ($hubungan_options as $hub)
                                                <option value="{{ $hub }}" {{ old('hubungan_kontak_darurat', $karyawan->hubungan_kontak_darurat ?? '') == $hub ? 'selected' : '' }}>
                                                    {{ $hub }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_cuti') is-invalid @enderror"
                                            ...
                                            value="{{ old('izin_cuti', $karyawan->izin_cuti) }}">
                                        @error('izin_cuti')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('izin_lainnya', $karyawan->izin_lainnya) }}">
                                        @error('izin_lainnya')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_telat') is-invalid @enderror"
                                            ...
                                            value="{{ old('izin_telat', $karyawan->izin_telat) }}">
                                        @error('izin_telat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('izin_pulang_cepat', $karyawan->izin_pulang_cepat) }}">
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                value="{{ old('makan_transport', $karyawan->makan_transport) }}">
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                name="bonus_team" value="{{ old('bonus_team', $karyawan->bonus_team) }}">
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_team')
