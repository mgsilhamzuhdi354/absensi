                                        ...
                                        <div class="tf-container">
                                            <div class="tf-balance-box">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div
                                                        class="inner-left d-flex justify-content-between align-items-center">
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/' . auth()->user()->id) }}"
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" readonly class="@error('name') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="@error('telepon') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" readonly class="@error('username') is-invalid @enderror"
                                                    name="username"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="lokasi_id" id="lokasi_id"
                                                    class="@error('lokasi_id') is-invalid @enderror" disabled>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" readonly class="@error('tgl_lahir') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <textarea name="alamat" id="alamat"
                                                    class="@error('alamat') is-invalid @enderror">{{ old('alamat', auth()->user()->alamat) }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" readonly class="@error('tgl_join') is-invalid @enderror"
                                                    id="tgl_join" name="tgl_join"
                                                    value="{{ old('tgl_join', auth()->user()->tgl_join) }}" disabled>
                                                @error('tgl_join')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="@error('masa_kerja') is-invalid @enderror"
                                                    id="masa_kerja" name="masa_kerja"
                                                    value="{{ old('masa_kerja', $masa_kerja) }}" disabled>
                                                @error('masa_kerja')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" readonly class="@error('gender') is-invalid @enderror"
            ...
            "is_admin" => "user"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="status_nikah" id="status_nikah"
                                                    class="@error('status_nikah') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="jabatan_id" id="jabatan_id"
                                                    class="@error('jabatan_id') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly class="@error('ktp') is-invalid @enderror"
                                                    id="ktp" name="ktp" value="{{ old('ktp', auth()->user()->ktp) }}">
                                                @error('ktp')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly
                                                    class="@error('kartu_keluarga') is-invalid @enderror"
                                                    id="kartu_keluarga" name="kartu_keluarga"
                                                    value="{{ old('kartu_keluarga', auth()->user()->kartu_keluarga) }}">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly
                                                    class="@error('bpjs_kesehatan') is-invalid @enderror"
                                                    id="bpjs_kesehatan" name="bpjs_kesehatan"
                                                    value="{{ old('bpjs_kesehatan', auth()->user()->bpjs_kesehatan) }}">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly
                                                    class="@error('bpjs_ketenagakerjaan') is-invalid @enderror"
                                                    id="bpjs_ketenagakerjaan" name="bpjs_ketenagakerjaan"
                                                    value="{{ old('bpjs_ketenagakerjaan', auth()->user()->bpjs_ketenagakerjaan) }}">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly class="@error('npwp') is-invalid @enderror"
                                                    id="npwp" name="npwp" value="{{ old('npwp', auth()->user()->npwp) }}">
                                                @error('npwp')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" readonly class="@error('sim') is-invalid @enderror"
                                                    id="sim" name="sim" value="{{ old('sim', auth()->user()->sim) }}">
                                                @error('sim')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" class="@error('no_pkwt') is-invalid @enderror"
                                                    id="no_pkwt" name="no_pkwt"
                                                    value="{{ old('no_pkwt', auth()->user()->no_pkwt) }}" disabled>
                                                @error('no_pkwt')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" class="@error('no_kontrak') is-invalid @enderror"
                                                    id="no_kontrak" name="no_kontrak"
                                                    value="{{ old('no_kontrak', auth()->user()->no_kontrak) }}" disabled>
                                                @error('no_kontrak')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="datetime"
                                                    class="@error('tanggal_mulai_pkwt') is-invalid @enderror"
                                                    id="tanggal_mulai_pkwt" name="tanggal_mulai_pkwt"
                                                    value="{{ old('tanggal_mulai_pkwt', auth()->user()->tanggal_mulai_pkwt) }}"
                                                    disabled>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="datetime"
                                                    class="@error('tanggal_berakhir_pkwt') is-invalid @enderror"
                                                    id="tanggal_berakhir_pkwt" name="tanggal_berakhir_pkwt"
                                                    value="{{ old('tanggal_berakhir_pkwt', auth()->user()->tanggal_berakhir_pkwt) }}"
                                                    disabled>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="@error('nama_rekening') is-invalid @enderror"
                                ...
                                <ul class="mt-3 mb-5">
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/' . auth()->user()->id) }}"
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <div class="group-input">
                                                <label>Cuti</label>
                                                <input type="number" class="@error('izin_cuti') is-invalid @enderror"
                                                    name="izin_cuti"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" class="@error('izin_lainnya') is-invalid @enderror"
                                                    name="izin_lainnya"
                                                    value="{{ old('izin_lainnya', auth()->user()->izin_lainnya) }}"
                                                    readonly />
                                                @error('izin_lainnya')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number" class="@error('izin_telat') is-invalid @enderror"
                                                    name="izin_telat"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="number"
                                                    class="@error('izin_pulang_cepat') is-invalid @enderror"
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/' . auth()->user()->id) }}"
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('gaji_pokok') is-invalid @enderror"
                                                    name="gaji_pokok"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text"
                                                    class="money @error('makan_transport') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                <label>Lembur</label>
                                                <input type="text" class="money @error('lembur') is-invalid @enderror"
                                                    name="lembur" value="{{ old('lembur', auth()->user()->lembur) }}"
                                                    readonly />
                                                @error('lembur')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('kehadiran') is-invalid @enderror"
                                                    name="kehadiran"
                                            ...
                                            <div class="group-input">
                                                <label>THR/Bonus/Insentif</label>
                                                <input type="text" class="money @error('thr') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text"
                                                    class="money @error('bonus_pribadi') is-invalid @enderror"
                                                    name="bonus_pribadi"
                                                    value="{{ old('bonus_pribadi', auth()->user()->bonus_pribadi) }}"
                                                    readonly />
                                                @error('bonus_pribadi')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('bonus_team') is-invalid @enderror"
                                                    name="bonus_team"
                                                    value="{{ old('bonus_team', auth()->user()->bonus_team) }}" readonly />
                                                @error('bonus_team')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text"
                                                    class="money @error('bonus_jackpot') is-invalid @enderror"
                                                    name="bonus_jackpot"
                                                    value="{{ old('bonus_jackpot', auth()->user()->bonus_jackpot) }}"
                                                    readonly />
                                                @error('bonus_jackpot')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                ...
                                <ul class="mt-3 mb-5">
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/' . auth()->user()->id) }}"
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <div class="group-input">
                                                <label>Izin</label>
                                                <input type="text" class="money @error('izin') is-invalid @enderror"
                                                    name="izin" value="{{ old('izin', auth()->user()->izin) }}" readonly />
                                                @error('izin')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('terlambat') is-invalid @enderror"
                                                    name="terlambat"
                                            ...
                                            <div class="group-input">
                                                <label>Mangkir</label>
                                                <input type="text" class="money @error('mangkir') is-invalid @enderror"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('saldo_kasbon') is-invalid @enderror"
                                                    name="saldo_kasbon"
                                                    value="{{ old('saldo_kasbon', auth()->user()->saldo_kasbon) }}"
                                                    readonly />
                                                @error('saldo_kasbon')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
