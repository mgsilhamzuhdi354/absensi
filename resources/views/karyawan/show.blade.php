                        ...
                        <div class="row">
                            <div class="col-10">
                                <div class="input-field">
                                    ...
                                    <input required class="search-field value_input" placeholder="Search" name="search"
    ...
    <div class="repicient-content">
        <div class="tf-container">
            <div class="box-user mt-5 text-center">
                ...
                <p style="font-size: 12px; color: #666;">Employee ID: {{ $user->employee_id ?? '-' }}</p>
            ...
            <ul class="mt-7">
                ...
                <li class="list-user-info"><span class="fa fa-user-secret"></span>{{ $user->Jabatan->nama_jabatan ?? '-' }}
                </li>
                ...
                <li class="list-user-info"><span class="icon-phone"></span><a
                        href="https://wa.me/{{ $user->whatsapp($user->telepon) }}">{{ $user->telepon }}</a></li>
                <li class="list-user-info"><span class="icon-email"></span><a
                        href="mailto:{{ $user->email }}">{{ $user->email }}</a></li>
                <li class="mt-4"><span class="fa fa-baby me-3" style="font-size: 20px; color:black"></span> <span
                        style="color:black; font-size:14px">{{ $tgl_lahir->format('d M Y') }}</span> <span
                        style="font-style: italic; font-size:12px; color:rgb(139, 139, 139); float:right"> Tanggal
                        Lahir</span></li>
                <hr style="color: rgb(204, 204, 204)">
                <li class="mt-2"><span class="fa fa-sign-in-alt me-3" style="font-size: 20px; color:black"></span> <span
                        style="color:black; font-size:14px">{{ $tgl_join->format('d M Y') }}</span> <span
                        style="font-style: italic; font-size:12px; color:rgb(139, 139, 139); float:right"> Tanggal
                        Join</span></li>
                <hr style="color: rgb(204, 204, 204)">
            </ul>
