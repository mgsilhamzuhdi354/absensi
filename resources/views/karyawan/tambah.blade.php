            ...
            "is_admin" => "user"
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('ktp') is-invalid @enderror" id="ktp" name="ktp"
                                value="{{ old('ktp') }}">
                            @error('ktp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('bpjs_ketenagakerjaan') is-invalid @enderror"
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('sim') is-invalid @enderror" id="sim" name="sim"
                                value="{{ old('sim') }}">
                            @error('sim')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('no_pkwt') is-invalid @enderror" id="no_pkwt"
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="datetime" class="form-control @error('tanggal_mulai_pkwt') is-invalid @enderror"
                                id="tanggal_mulai_pkwt" name="tanggal_mulai_pkwt" value="{{ old('tanggal_mulai_pkwt') }}">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="datetime" class="form-control @error('tanggal_berakhir_pkwt') is-invalid @enderror"
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('izin_lainnya') is-invalid @enderror"
                                id="izin_lainnya" name="izin_lainnya" value="{{ old('izin_lainnya') }}">
                            @error('izin_lainnya')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('izin_telat') is-invalid @enderror"
                                id="izin_telat" name="izin_telat" value="{{ old('izin_telat') }}">
                            @error('izin_telat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="number" class="form-control @error('izin_pulang_cepat') is-invalid @enderror"
                                id="izin_pulang_cepat" name="izin_pulang_cepat" value="{{ old('izin_pulang_cepat') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control money @error('makan_transport') is-invalid @enderror"
                                    name="makan_transport" value="{{ old('makan_transport') }}">
                                <div class="input-group-text">
                                    <span>/ Bulan</span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control money @error('thr') is-invalid @enderror" name="thr"
                                    value="{{ old('thr') }}">
                                <div class="input-group-text">
                                    <span>/ Bulan</span>
                                </div>
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control money @error('bonus_pribadi') is-invalid @enderror"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control money @error('bonus_jackpot') is-invalid @enderror"
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control money @error('saldo_kasbon') is-invalid @enderror"
