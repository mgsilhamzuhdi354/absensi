    ...
    <div class="row">
                    ...
                    <div class="text-center">
                        ...
                        @else
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{ url('storage/' . auth()->user()->foto_karyawan) }}" alt="User profile picture">
                        @endif
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="text" class="form-control @error('masa_kerja') is-invalid @enderror"
                                            id="masa_kerja" name="masa_kerja" value="{{ old('masa_kerja', $masa_kerja) }}"
                                            disabled>
                                        @error('masa_kerja')
                                            <div class="invalid-feedback">
                                                {{ $message }}
        ...
        [
            "is_admin" => "user"
                                ...
                                <div class="row">
                                    <div class="col-6 mb-4">
                                        ...
                                        <input type="datetime"
                                            ...
                                            id="masa_berlaku" name="masa_berlaku" disabled
                                            value="{{ old('masa_berlaku', auth()->user()->masa_berlaku ? auth()->user()->masa_berlaku : 'Permanen') }}">
                                        @error('masa_berlaku')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_cuti') is-invalid @enderror"
                                            ...
                                            value="{{ old('izin_cuti', auth()->user()->izin_cuti) }}" disabled>
                                        @error('izin_cuti')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('izin_lainnya', auth()->user()->izin_lainnya) }}" disabled>
                                        @error('izin_lainnya')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_telat') is-invalid @enderror"
                                            ...
                                            value="{{ old('izin_telat', auth()->user()->izin_telat) }}" disabled>
                                        @error('izin_telat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                name="gaji_pokok"
                                                value="{{ old('gaji_pokok', auth()->user()->gaji_pokok) }}" disabled>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                name="lembur" value="{{ old('lembur', auth()->user()->lembur) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Jam</span>
                                            </div>
                                            @error('lembur')
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        <label for="thr">THR/Bonus/Insentif</label>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control money @error('thr') is-invalid @enderror"
                                                name="thr" value="{{ old('thr', auth()->user()->thr) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('thr')
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                name="bonus_pribadi"
                                                value="{{ old('bonus_pribadi', auth()->user()->bonus_pribadi) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus')
                                ...
                                <div class="row">
                                    <div class="col-6 mb-4">
                                        <label for="bonus_team">Tunjangan Transport</label>
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                class="form-control money @error('bonus_team') is-invalid @enderror"
                                                name="bonus_team"
                                                value="{{ old('bonus_team', auth()->user()->bonus_team) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_team')
                                    ...
                                    <div class="col-6 mb-4">
                                        <label for="bonus_jackpot">Tunjangan Komunikasi</label>
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                class="form-control money @error('bonus_jackpot') is-invalid @enderror"
                                                name="bonus_jackpot"
                                                value="{{ old('bonus_jackpot', auth()->user()->bonus_jackpot) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_jackpot')
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                value="{{ old('izin', auth()->user()->izin) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ hari</span>
                                            </div>
                                            @error('izin')
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                name="saldo_kasbon"
                                                value="{{ old('saldo_kasbon', auth()->user()->saldo_kasbon) }}" disabled>
                                            <div class="input-group-text">
                                                <span>/ Tahun</span>
                                            </div>
                                            @error('saldo_kasbon')
