                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($dl->status !== 'Approved' && $dl->jam_keluar !== null)
                                            <ul class="action">
                                                <li>
                                                    <button class="border-0" style="background-color: transparent" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#lemburModal{{ $dl->id }}"><i style="color:blue" class="fa fa-check-circle"></i></button>

                                                    <div class="modal fade" id="lemburModal{{ $dl->id }}" tabindex="-1" role="dialog" aria-labelledby="lemburModalLabel{{ $dl->id }}" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="lemburModalLabel{{ $dl->id }}">Approval - {{ $dl->User->name ?? 'Lembur' }}</h5>
