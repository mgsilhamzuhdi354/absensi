                        ...
                        <div class="flex-grow-1">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              ...
                              <form action="{{ url('/notifications/delete-read') }}" method="POST"
                              ...
                              <form action="{{ url('/notifications/delete-all') }}" method="POST" style="display: inline;"
                ...
                <div class="inbox">
                  @foreach ($inboxs as $inbox)
                    ...
                    <div class="d-flex align-items-center"
                      ...
                      <form action="{{ url('/notifications/delete/' . $inbox->id) }}" method="POST" style="padding: 10px;"
