                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" step="0.01" min="0" max="100" class="form-control @error('pph21_persen') is-invalid @enderror" name="pph21_persen" value="{{ old('pph21_persen', '0') }}" id="pph21_persen">
                                    <div class="input-group-text">
                                        <span>% dari Gaji Pokok</span>
                                    </div>
                                    @error('pph21_persen')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('pph21_amount') is-invalid @enderror" id="pph21_amount" name="pph21_amount" value="{{ old('pph21_amount', '0') }}" readonly style="background-color: #e9ecef">
                                    <div class="input-group-text">
                                        <span>Nominal PPh 21</span>
                                    </div>
                                    @error('pph21_amount')
                                        <div class="invalid-feedback">
                                            {{ $message }}
