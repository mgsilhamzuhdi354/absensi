                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('pph21_persen') is-invalid @enderror" name="pph21_persen" value="{{ old('pph21_persen', $data->pph21_persen ?? 0) }}" id="pph21_persen">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('bpjs_jht_amount') is-invalid @enderror" id="bpjs_jht_amount" name="bpjs_jht_amount" value="{{ old('bpjs_jht_amount', $data->bpjs_jht_amount ?? 0) }}">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('bpjs_jht_persen') is-invalid @enderror" name="bpjs_jht_persen" value="{{ old('bpjs_jht_persen', $data->bpjs_jht_persen ?? 2) }}" id="bpjs_jht_persen">
                                    <div class="input-group-text"><span>% dari Gaji Pokok</span></div>
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('bpjs_kes_amount') is-invalid @enderror" id="bpjs_kes_amount" name="bpjs_kes_amount" value="{{ old('bpjs_kes_amount', $data->bpjs_kes_amount ?? 0) }}">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('bpjs_kes_persen') is-invalid @enderror" name="bpjs_kes_persen" value="{{ old('bpjs_kes_persen', $data->bpjs_kes_persen ?? 1) }}" id="bpjs_kes_persen">
                                    <div class="input-group-text"><span>% dari Gaji Pokok</span></div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#bpjs_jht_amount').on('keyup', function() {
                    var gaji_pokok = $('#gaji_pokok').val() ? parseFloat(replaceCurrency($('#gaji_pokok').val())) : 0;
                    var amount = $(this).val() ? parseFloat(replaceCurrency($(this).val())) : 0;
                    if (gaji_pokok > 0) { $('#bpjs_jht_persen').val((amount / gaji_pokok * 100).toFixed(2)); }
                });
                $('#bpjs_jht_persen').on('keyup', function() {
                    var gaji_pokok = $('#gaji_pokok').val() ? parseFloat(replaceCurrency($('#gaji_pokok').val())) : 0;
                    var persen = $(this).val() ? parseFloat($(this).val()) : 0;
                    $('#bpjs_jht_amount').val(accounting.formatMoney(Math.round(gaji_pokok * persen / 100), '', 0, ",", "."));
                });

                // BPJS Kesehatan real-time
                $('#bpjs_kes_amount').on('keyup', function() {
                    var gaji_pokok = $('#gaji_pokok').val() ? parseFloat(replaceCurrency($('#gaji_pokok').val())) : 0;
                    var amount = $(this).val() ? parseFloat(replaceCurrency($(this).val())) : 0;
                    if (gaji_pokok > 0) { $('#bpjs_kes_persen').val((amount / gaji_pokok * 100).toFixed(2)); }
                });
                $('#bpjs_kes_persen').on('keyup', function() {
                    var gaji_pokok = $('#gaji_pokok').val() ? parseFloat(replaceCurrency($('#gaji_pokok').val())) : 0;
                    var persen = $(this).val() ? parseFloat($(this).val()) : 0;
                    $('#bpjs_kes_amount').val(accounting.formatMoney(Math.round(gaji_pokok * persen / 100), '', 0, ",", "."));
                });
